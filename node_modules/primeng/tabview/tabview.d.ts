...
export declare class TabView implements AfterContentInit, AfterViewChecked, OnDestroy, BlockableUI {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TabView, "p-tabView", never, { "orientation": { "alias": "orientation"; "required": false; }; "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "controlClose": { "alias": "controlClose"; "required": false; }; "scrollable": { "alias": "scrollable"; "required": false; }; "activeIndex": { "alias": "activeIndex"; "required": false; }; }, { "onChange": "onChange"; "onClose": "onClose"; "activeIndexChange": "activeIndexChange"; }, ["tabPanels", "templates"], ["*"], false, never>;
}
